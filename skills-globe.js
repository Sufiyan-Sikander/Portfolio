...
const skillsData = [
    ...
    { name: 'Roboflow', icon: '🤖', category: 'Platforms', slug: 'roboflow', color: '#FF6C37' },
    ...
    { name: 'Django', icon: '🌐', category: 'Frameworks', slug: 'django', color: '#092E20' },
    { name: 'Flask', icon: '🍶', category: 'Frameworks', slug: 'flask', color: '#000000' },
    { name: 'Celery', icon: '🍒', category: 'Frameworks', slug: 'celery', color: '#F7E018' },
    { name: 'Redis', icon: '🗄️', category: 'Frameworks', slug: 'redis', color: '#D82C20' },
    ...
    { name: 'AWS', icon: '☁️', category: 'Cloud', slug: 'amazonaws', color: '#FF9900' },
